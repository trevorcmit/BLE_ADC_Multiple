...
#define DEF_SVC1_ADC_VAL_1_CHAR_LEN      201
...
#define DEF_SVC2_WRITE_VAL_1_CHAR_LEN    2

#define DEF_SVC2_WRITE_VAL_1_USER_DESC   "Write me (app db)"
...
#define DEF_SVC3_READ_VAL_1_USER_DESC    "Read me (app db)"
